      ...
      <React.Fragment>
        ...
        <div className="container-fluid mb-2">
          <div className="row p-0">
            ...
            <div className="col-lg-7 col-md-12 p-0 m-0 order-3">
              <ChartCard
            ...
            <div className="col-lg-5 col-md-12 p-0 m-0 order-4">
              <ChartCard
                ...
                cardContent={
                  <Tables
                    ...
                    tableBody={CreateArrayAgencyType(
                      ...
                      <tr key={item.index}>
                        <td className="text-info">{item.label}</td>
                        <td>{parseInteger(item.agencyAllocated)}</td>
                        <td>{parseInteger(item.agencyUsed)}</td>
                        <td>{parseInteger(item.agencyStatus)}%</td>
                      </tr>
                    ))}
                  />
                }
